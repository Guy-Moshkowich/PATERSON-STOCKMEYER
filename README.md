...
<img src="https://latex.codecogs.com/gif.latex?x^2,\dots,x^k&space;\text{\&space;and&space;}&space;x^{2k},x^{4k},\dots,x^{pk}" title="x^2,\dots,x^k \text{\ and } x^{2k},x^{4k},\dots,x^{2^{m-1}k}" />.
